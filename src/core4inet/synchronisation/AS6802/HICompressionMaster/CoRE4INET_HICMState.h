...
class HICMState{
    ...
    map<long int, PCFrame * > *compressed_frames;
	...
	virtual void compressionFunction(cMessage *message, HICM *sicm){}
    ...
    int getBitPosition(unsigned int bitVector){
        ...
        return -1;
            ...
            bool inSchedule(unsigned int permanence_pit, unsigned int sc_receive_pit, unsigned int precission){
                ...
                bool inSchedule2(unsigned int permanence_pit, unsigned int sc_receive_pit, unsigned int acceptance_window){

                    if((permanence_pit >= (sc_receive_pit - (acceptance_window/2)))&&(permanence_pit <= (sc_receive_pit + (acceptance_window/2)))){
        ...
        int compress(vector<pair<unsigned int,unsigned int> > *vct, int faulty_sms){
                ...
                switch(numberOfInputs){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        compression_correction = (vct->at(1).second - vct->at(0).second)/2;
                        break;
                    case 3:
                        compression_correction = (vct->at(1).second - vct->at(0).second);
                        break;
                    case 4:
                        compression_correction = ((vct->at(1).second - vct->at(0).second)+(vct->at(2).second - vct->at(0).second))/2;
                        break;
                    case 5:
                        compression_correction = ((vct->at(1).second - vct->at(0).second)+(vct->at(3).second - vct->at(0).second))/2;
                        break;
